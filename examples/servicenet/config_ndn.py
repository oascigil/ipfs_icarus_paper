...
VIDEO_PLAYBACK_RATE = 20
BUFFER_SIZE = 10*VIDEO_PLAYBACK_RATE
...
STRATEGIES = ['NDN']  # service-based routing
...
PLAYBACK_BUFFERS = [2*VIDEO_PLAYBACK_RATE]
for strategy in STRATEGIES:
    for buffer_size in PLAYBACK_BUFFERS:
        ...
        if strategy is 'NDN':
            ...
            experiment['warmup_strategy']['load_balance_distance'] = 2
            experiment['strategy']['n_contents'] = N_CONTENTS
            experiment['strategy']['advertisement_period'] = 5.0
            experiment['strategy']['load_balance_distance'] = 2
