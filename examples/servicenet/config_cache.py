...
STRATEGIES = ['NDN', 'NDN_MEASUREMENT', 'IPFS']  # service-based routing
...
for strategy in STRATEGIES:
    for cache_size in CACHE_SIZES:
        ...
        experiment['cache_placement']['network_cache_size'] = cache_size
        if strategy is 'NDN':
            experiment['warmup_strategy']['load_balance_distance'] = 1
            experiment['strategy']['load_balance_distance'] = 1
        experiment['desc'] = "strategy: %s cache size %s" \
                         % (strategy, str(cache_size))
        EXPERIMENT_QUEUE.append(experiment)
#"""
