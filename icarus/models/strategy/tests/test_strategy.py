...
class TestHashroutingEdge(unittest.TestCase):
    ...
    def test_hashrouting_symmetric_edge(self):
        ...
        self.assertIn("s", loc)
        self.assertIn(4, loc)
        self.assertTrue(self.view.local_cache_peek(1, 4))
        self.assertFalse(self.view.local_cache_peek(2, 4))
        self.assertFalse(self.view.local_cache_peek(3, 4))
        ...
        self.assertIn("s", loc)
        self.assertIn(3, loc)
        self.assertTrue(self.view.local_cache_peek(1, 7))
        self.assertFalse(self.view.local_cache_peek(2, 7))
        self.assertFalse(self.view.local_cache_peek(3, 7))
        summary = self.collector.session_summary()
        ...
        self.assertFalse(self.view.local_cache_peek(1, 4))
        self.assertFalse(self.view.local_cache_peek(2, 4))
        self.assertFalse(self.view.local_cache_peek(3, 4))
        # Request again 4
        hr.process_event(1, "r", 4, True)
    ...
    def test_hashrouting_symmetric_edge_zero_local(self):
        ...
        self.assertIn("s", loc)
        self.assertIn(3, loc)
        self.assertFalse(self.view.local_cache_peek(1, 7))
        self.assertFalse(self.view.local_cache_peek(2, 7))
        self.assertFalse(self.view.local_cache_peek(3, 7))
        summary = self.collector.session_summary()
        exp_req_hops = [("r", 1), (1, 2), (2, 3), (3, "s")]
...
class TestHashroutingOnPath(unittest.TestCase):
    ...
    def test_hashrouting_symmetric(self):
        ...
        self.assertTrue(self.view.local_cache_peek(1, 4))
        self.assertFalse(self.view.local_cache_peek(2, 4))
        self.assertTrue(self.view.local_cache_peek(3, 4))
        summary = self.collector.session_summary()
        exp_req_hops = [("r", 1), (1, 4), (4, 3), (3, "s")]
        exp_cont_hops = [("s", 3), (3, 4), (4, 1), (1, "r")]
        req_hops = summary['request_hops']
        ...
        self.assertIn(3, loc)
        self.assertTrue(self.view.local_cache_peek(1, 7))
        self.assertTrue(self.view.local_cache_peek(2, 7))
        self.assertFalse(self.view.local_cache_peek(3, 7))
        summary = self.collector.session_summary()
        exp_req_hops = [("r", 1), (1, 2), (2, 3), (3, "s")]
        exp_cont_hops = [("s", 3), (3, 2), (2, 1), (1, "r")]
